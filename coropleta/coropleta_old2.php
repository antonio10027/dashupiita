...
$('#submit').on('click', function(){
  ...
  console.log("date ", yearEnd);
    ...
    //document.getElementById('selectContam').addEventListener('change',function(e){
    ...
    if (map != undefined) { // para quitar la capa anterior cada que se seleccione desde el select
       ...
       map= map.remove();
        ...
        function style(feature) {
            var fillColor;
           /* Esto se usaría por si se tiene un geojson con todos los valores de todos los
           contaminantes... 
            switch(elemento){
                case 'so2':
        ...
        //const api = "php/contaminantes.php?var='se pasó la variable'"; variable?
